...
show_volume_meters
        call restore_mmu
        ld a,(stp.AYREG_AmplA)
        and $0f
        ld hl,8*256+18
        call print_meter
        ld a,(stp.AYREG_AmplB)
        and $0f
        ld hl,8*256+19
        call print_meter
        ld a,(stp.AYREG_AmplC)
        and $0f
        ld hl,8*256+20
        call print_meter
        jp map_pt3_data
...
meterBuffer  defs 33
        ...
        include "stp_player.i.asm"

plugin_end
        assert plugin_end - plugin_start <= VIEW_PLUGIN_SIZE
        SAVEBIN "plugin/STP_STP-Player.CCP", VIEW_PLUGIN_ADDRESS, VIEW_PLUGIN_SIZE
